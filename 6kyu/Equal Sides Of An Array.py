...
of the array, the sum of left side of the index ({1,2,3}) and the sum of the right side of the index ({3,2,
1}) both equal 6.
...
def find_even_index(arr):
    left_value, right_value = 0, sum(arr)
...
def find_even_index_complicated(arr):
...
start_time = time.time()
for _ in range(10000):
    find_even_index_complicated([1, 2, 3, 4, 3, 2, 1])
    find_even_index_complicated([1, 100, 50, -51, 1, 1])
    find_even_index_complicated([1, 2, 3, 4, 5, 6])
    find_even_index_complicated([20, 10, 30, 10, 10, 15, 35])
    find_even_index_complicated([20, 10, -80, 10, 10, 15, 35])
    find_even_index_complicated([10, -80, 10, 10, 15, 35, 20])
    find_even_index_complicated(list(range(1, 100)))
    find_even_index_complicated([0, 0, 0, 0, 0])
    find_even_index_complicated([-1, -2, -3, -4, -3, -2, -1])
    find_even_index_complicated(list(range(-100, -1)))
print("--- %s seconds ---" % (time.time() - start_time))

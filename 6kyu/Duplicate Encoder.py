...
Examples "din"      =>  "(((" "recede"   =>  "()()()" "Success"  =>  ")())())" "(( @"     =>  "))((" Notes Assertion
messages may be unclear about what they display in some languages. If you read "...It Should encode XXX",
...
def duplicate_encode(word):
    ...
    return ''.join(['(' if count[x] < 2 else ')' for x in word.lower()])

...
to another. The directions were "NORTH", "SOUTH", "WEST", "EAST". Clearly "NORTH" and "SOUTH" are opposite,
"WEST" and "EAST" too.
...
immediately "SOUTH" is not reasonable, better stay to the same place! So the task is to give to the man a simplified
...
returns nil when the path is reduced to nothing. The Rust version takes a slice of enum Direction {North, East, West,
South}. See more examples in "Sample Tests:" Notes Not all paths can be made simpler. The path ["NORTH", "WEST",
